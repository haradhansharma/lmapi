...
from .views import LicenseDetailView, LicenseActivationView, APIHome, LicenseRecordUpdateOrCreateAPIView
...
urlpatterns = [
    ...
    path('license/updateorcreate/<str:un>/', LicenseRecordUpdateOrCreateAPIView.as_view(), name='record-update-or-create-api'), 
